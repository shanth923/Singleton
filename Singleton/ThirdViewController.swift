...
class ThirdViewController: UIViewController,UITextFieldDelegate{
    ...
    @IBAction func submitAction(_ sender: UIButton) {
        ...
        FormData.shared.sanskrit2 =  sanskrit.text
        FormData.shared.english2 =  english2.text
        FormData.shared.math2a =  math2a.text
        FormData.shared.maths2b =  maths22b.text
        FormData.shared.chemestry2 =  chemetry.text
        FormData.shared.physics2 =  phyics.text
